<main>
 ...
 <td><img src=".base_url('assets/photo/surat_masuk/'.$suratdata->image)." width ='64'/>
 </td>

 <td><div><a href=".base_url('admin/surat_masuk/getedit/' . $suratdata->id)." class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Edit</a>
